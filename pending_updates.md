...
(historical audit notes only; no active bloat)
...
- README.md: LLM/agent edit — v4.0.1 post-cleanup hygiene (health coerce+prune, pending clean, junk rm, monitors, banners); FRESH 3 before edit; subagent_id=m5-gamma-coord-agents
