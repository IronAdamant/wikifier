...
|------|--------|--------------|-----------------|
| skills/run.md | 🟢 Green | 2026-06-10 19:13:46 AEST | v4.3.0 release prep verified: version reads 4.3.0 everywhere incl. dynamic sh banner; 30/30 tests |
...
| wikifier.sh | 🟢 Green | 2026-06-10 19:09:19 AEST | Verified: 30/30 unittest, exports 8/8, churn 4/4; sh update-maps 3m39s->2.0s + hung incremental now 1.5s; Babylon scoped re-run 75min->80.6s, cache 274MB->101MB; all 12 sh commands smoke-tested |
...
| README.md | 🟢 Green | 2026-06-10 19:13:41 AEST | v4.3.0 release prep verified: version reads 4.3.0 everywhere incl. dynamic sh banner; 30/30 tests |
...
| CHANGELOG.md | 🟢 Green | 2026-06-10 19:13:43 AEST | v4.3.0 release prep verified: version reads 4.3.0 everywhere incl. dynamic sh banner; 30/30 tests |
...
| wikifier/__init__.py | 🟢 Green | 2026-06-10 19:13:44 AEST | v4.3.0 release prep verified: version reads 4.3.0 everywhere incl. dynamic sh banner; 30/30 tests |
...
| wikifier/scripts/wikifier.sh | 🟢 Green | 2026-06-10 19:09:21 AEST | Verified: 30/30 unittest, exports 8/8, churn 4/4; sh update-maps 3m39s->2.0s + hung incremental now 1.5s; Babylon scoped re-run 75min->80.6s, cache 274MB->101MB; all 12 sh commands smoke-tested |
