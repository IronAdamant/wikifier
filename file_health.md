...
|------|--------|--------------|-----------------|
| skills/run.md | 🟢 Green | 2026-06-04 18:26:28 AEST | Human layer docs added for investigation + LLM paste. FRESH+record. subagent_id=human-layer-plan |
...
| README.md | 🟢 Green | 2026-06-04 18:26:27 AEST | Human dashboard sub-project enabled (init copy, auto-reload, text exports). FRESH+record. subagent_id=human-layer-plan |
...
| wikifier/mcp/README.md | 🟢 Green | 2026-06-04 18:26:28 AEST | MCP human sub-project doc. FRESH+record. subagent_id=human-layer-plan |
